...
alias aws-dns='export instanceUrl=`aws ec2 describe-instances --filters "Name=instance-id,Values=$instanceId" --query "Reservations[0].Instances[0].PublicDnsName"` && echo $instanceUrl'
